    ...
    def generate_documents(self):
        ...
        for i in self.complete_schedule:
            for j in range(1, 101):
                self.seats.append({"class": "economy", "seatNumber": j, "travelId": i["travelId"], "bookingId": None, "isUnderAgeTwo": False, "isYoung": False, "isAged": False})
            for j in range(6):
                for k in range(6):
                    self.seats.append({"class": "business", "seatNumber": chr(65+j)+str(k), "travelId": i["travelId"], "bookingId": None, "isUnderAgeTwo": False, "isYoung": False, "isAged": False})
